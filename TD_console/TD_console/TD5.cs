...
namespace TD_console
{
    public class TD5
    {
        ...
        {
            Writer("Titaah_encode", "Hello world !", "Titititi ti titaahtiti titaahtiti taahtaahtaah, titaahtaah taahtaahtaah titaahti titaahtiti taahtiti, !", Titaah_encode("Hello world !"));
            Writer("Titaah_decode", "Titititi ti titaahtiti titaahtiti taahtaahtaah, titaahtaah taahtaahtaah titaahti titaahtiti taahtiti, !", "Hello world !", Titaah_decode("Titititi ti titaahtiti titaahtiti taahtaahtaah, titaahtaah taahtaahtaah titaahti titaahtiti taahtiti, !"));
        ...
        public static string Titaah_decode(string sentence)
        {
            ...
            tmp1 = TD4.Morse_decode(sentence);

            // Je voulais boucler pour catcher n'importe quel autre Maj Char mais manque de temps
            tmp1 = tmp1.Replace("W", "w");
        ...
        public static string Laby(int[][][] map)
        {
            ...
            // Ne rien modifier au dessus de ce commentaire
            //string labyBis = "";
            //// Connaitre la taille d'un tableau de tableau de tableau
            //int tabLength = map[0].Length;
            ...
            //    }
            //}
            //for (int x = 0; x <= labyBis.Length - 1; x = x + 4)
            //{
            ...
            //    {
            //        /*
            //         * Si 0 = gauche = 1 = un mur "|" , sinon " "   
            //         * Si 1 = haut = 1 = donc ligne-1  =  un mur "|" , sinon " "
            //         * Si 2 = droite = 1 = un mur "|" , sinon " "             
            //         * Si 3 = bas = = 1 = un mur "|" , sinon " "
            //        */
            //        if(z <= tabLength-1)
            //        {
            //            laby += "_";
            ...
            //    }
            //    // Sort de la boucle afficher laby
            //}
            ////tmp2 = laby;
            //Console.WriteLine(laby);
            // Ne rien modifier au dessous de ce commentaire
